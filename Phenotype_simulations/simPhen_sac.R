...
genBg = read_background("/home/gerald/Documents/PhD/papers/paper4/bg_p10_3e5_ids.RData", sac_idx)
...
sac_genotypes = filter_genotypes(data, sac_idx)
#sac_genotypes = filter_genotypes(data, sac_idx)
sac_freqs = list(nama_idx, gbr_idx, msl_idx, eas_idx, sas_idx)


# simulate 10 genetic variant effects (from non-standardised SNP genotypes)
causalSNPs <- getCausalSNPs(N=5000, genotypes = sac_genotypes$genotypes, 
                            NrCausalSNPs = 10, verbose = FALSE)

#Check allele frequencies of causalSNPs
check_freqs(causalSNPs, sac_freqs)
...
writeLines(colnames(causalSNPs), paste("/home/gerald/Documents/PhD/papers/paper4/causalSNPs_3_sac.txt", sep = ""))
...
causal_IDs = which(colnames(sac_genotypes$genotypes) %in% colnames(causalSNPs))

anc_files = c("/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_ancs_nama_5000_bt.csv", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_ancs_gbr_5000_bt.csv", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_ancs_msl_5000_bt.csv", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_ancs_eas_5000_bt.csv", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_ancs_sas_5000_bt.csv")

lapply(anc_files, function(a){
  lapply(causal_IDs, function(e){
    system(paste("cut -f", e, " -d',' ", a, sep=""), intern = T) %>%
      as.numeric()
  }) %>%
    do.call("cbind", .) ->
    anc
...
gc()
anc_names = c("t_anc_nama","t_anc_gbr","t_anc_msl","t_anc_eas","t_anc_sas")
...
anc_names = c("t_apa_nama","t_apa_gbr","t_apa_msl","t_apa_eas","t_apa_sas")                                            
t_allele_anc = c()
#Nama:4, MSL:6, GBR:7 EP:8, EAS:10, SAS:11
lapply(1:5, function(p){
  ancFixed = anc[[p]]
...
int_files = c("/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_laaa_nama_5000_bt.desc", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_laaa_gbr_5000_bt.desc", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_laaa_msl_5000_bt.desc", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_laaa_eas_5000_bt.desc", "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_laaa_sas_5000_bt.desc")
...
anc_names = c("t_laaa_nama","t_laaa_gbr","t_laaa_msl","t_laaa_eas","t_laaa_sas")                                            
t_allele_anc = c()
#Nama:4, MSL:6, GBR:7 EP:8, EAS:10, SAS:11
lapply(1:5, function(p){
  ancFixed = anc[[p]]
...
phenotypes = cbind(t_allele, t_anc[[1]], t_apa[[1]], t_laaa[[1]], t_anc[[2]], t_apa[[2]], t_laaa[[2]], t_anc[[3]], t_apa[[3]], t_laaa[[3]], t_anc[[4]], t_apa[[4]], t_laaa[[4]], t_anc[[5]], t_apa[[5]], t_laaa[[5]])

glob_ancs = read.csv("/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_global_ancs_5000_ALL.csv", header=T)

age_sex = noiseFixed$cov
age_sex[,2] = as.integer(age_sex[,2])
phen_age_sex = data.frame("age" = age_sex[,1], "sex" = age_sex[,2], phenotypes,  glob_ancs[,c("NAMA", "GBR", "MSL", "EAS", "SAS")])
write.table(phen_age_sex, "/home/gerald/Documents/PhD/papers/paper4/true_anc/sac_5000_phenotypes_3.tsv", quote = F, sep = "\t", row.names = T, col.names = T)
